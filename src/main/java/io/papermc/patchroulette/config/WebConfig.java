...
public class WebConfig implements WebMvcConfigurer {
  ...
  static class FrontendResolver extends PathResourceResolver {
    ...
    protected Resource getResource(String resourcePath, Resource location) throws IOException {
      ...
      return DEV
          ? new FileSystemResource(DEV_STARTING_PAGE)
          : new ClassPathResource(DEFAULT_STARTING_PAGE);
    }
  }
  ...
  public void addResourceHandlers(ResourceHandlerRegistry registry) {
    ...
    handlerRegistration.resourceChain(true).addResolver(new FrontendResolver());
  }
}
